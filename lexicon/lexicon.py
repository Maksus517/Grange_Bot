...
LEXICON_WIKI_RU: dict[str, str] = {
    ...
    'wiki_error_answer': '<b>Вы находитесь в блоке "Википедия"</b>\n'
...
LEXICON_WEATHER_RU: dict[str, str] = {
    'open_weather_press_button': 'Выберете название города. Если вашего города нет в списке, напишите его в чат',

    'leave_here_open_weather': 'Хотите узнать погоду в другом городе еще?',
    ...
    'open_weather_error_answer': '<b>Вы находитесь в блоке "Погода"</b>\n'
